...
- You can watch the [youtube video](https://github.com/jmdvella/blender-scripts) for detailed instructions.
- Convert V-Ray Roughness Materials to FBX Standard (Legacy) Materials for exporting to FBX 
- Automatically locates any file that has "Occlusion" and "Ambient" or "AO" in the same directory as the Diffuse texture and places this in the specular channel.
...
- Install the [jv_convert_to_glb.py](https://github.com/jmdvella/blender-scripts/blob/main/jv_convert_to_glb.py) for blender and follow the install instructions [here](https://youtu.be/3L2XOsLHqto)
